			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12 col-xs-6 text-center">
					   <a class="primary-btn cta-btn" href="{{route('site.categories')}}">View All</a>
					</div>
				</div>
				<!-- /row -->
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="{{route('site.products')}}">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
