            ...
            <div class="row">
                <table id="cart" class="table table-hover table-condensed table-responsive">
                        ...
                        @if (session('wishlist'))
                            @foreach (session('wishlist') as $id => $details)
                                ...
                                <tr data-id="{{ $id }}">
                                    <td data-th="Product">
                                        <div class="row">
                                            <div class="col-sm-3 hidden-xs"><img src="{{asset('frontend/assets/uploads/products/'.$details['image'])}}"
                                    ...
                                    <td data-th="Subtotal" class="text-center cart-product-txt">
                                        ${{ $details['selling_price'] * $details['qty'] }}</td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="5" class="text-right">
                                <a href="{{ route('site.index') }}" class="primary-btn bg-black"><i
                                        class="fa fa-angle-left"></i> Continue Shopping</a>
                                <button class="primary-btn cta-btn text-white"><a class="text-white"
                                        href="{{ route('site.checkoutform', ['slug' => $prods->slug]) }}">Checkout <i
