   ...
   <div class="col-md-8">
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <p class="card-category">Edit your user here</p>
      </div>
      <div class="card-body">
        @if($errors->any())
        ...
        @endif
        <form action="{{route('user.edit.submit', $user->id)}}" method="post">
            @csrf
            @method('PATCH')
            <div class="row">
                ...
                <div class="col-md-6 my-3">
                    <div class="form-group bmd-form-group">
                        ...
                        <input id="email" type="email" class="form-control" value="{{$user->email}}" name="email" required autocomplete="email">
                    </div>
                </div>
            </div>
